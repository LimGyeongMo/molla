...
import com.example.daegurobus.databinding.CommonRadioCheckBoxBinding;

public class CommonRadioCheckBox extends RelativeLayout {
    private CommonRadioCheckBoxBinding binding;
    ...
    public CommonRadioCheckBox(Context context) {
        super(context);
        initView();
    }

    public CommonRadioCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
        getAttrs(attrs);
    }

    public CommonRadioCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        binding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.common_radio_check_box, null, false);
    ...
    public void setCheck() {
        ...
        binding.circleLine.getBackground().setColorFilter(getContext().getColor(R.color.white), PorterDuff.Mode.SRC_IN);
    ...
    public void setDisable() {
        ...
        binding.circleDot.setVisibility(View.GONE);
        binding.text.setTextColor(getContext().getColor(R.color.color_999999));
    }
